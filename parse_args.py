...
def collect_args():
    ...
    parser.add_argument(
        ...
        choices=["lp", "clip-zs", "clip-adapt", "seg2d-rand",
                 ...
                 "lora", "vera", 'boft', 'adalora', 'fourierft'],
    )
    ...
    parser.add_argument("--exp_path", type=str, default="../logs_freqfit/filter_complex_allinear_dino_fewshot1-1")
    ...
    parser.add_argument("--search_epoch", type=int, default=None)
    # parser.add_argument("--lambda_orth", type=float, default=0.01)

    parser.add_argument(
        "--tune_method",
        default='ori',
        choices=['ori', 'freqfit', 'ssf'])

    parser.add_argument("--test_interval", type=int,
                        default=None, help="not perform testing")
